...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, rotation=True, rotnet=None, classifier_bias=True):
        ...
        self.fc1 = nn.Linear(512*block.expansion, num_classes, bias=classifier_bias)
    ...
    def forward(self, x, classify=False, classify1=False):
        assert int(classify) + int(classify1) <= 1
        if classify == True:
            return self.fc(x)
        elif classify1 == True:
            return self.fc1(x)
